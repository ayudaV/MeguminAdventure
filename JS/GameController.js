...
player = {
    ...
    xDir: 0, //direção para onde ele irá se mover no x
    yDir: 0,
    ...
    move: function(xDir, yDir) { //controla o movimento do player
        this.x1 += xDir * this.velocidade
        this.y1 += yDir * this.velocidade
        this.xDir = 0
        this.yDir = 0
    },
...
function KeyPressed(e) {//função que identifica a tecla clicada e transfere para o player.
    if(e.keyCode == 68) {
        player.xDir += 1
    }
    if(e.keyCode == 65) {
